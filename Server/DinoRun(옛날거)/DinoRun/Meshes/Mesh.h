...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
#define VERTEXT_POSITION				0b00001
//#define VERTEXT_COLOR					0b00010
#define VERTEXT_NORMAL					0b00010
#define VERTEXT_TANGENT					0b00100
#define VERTEXT_TEXTURE_COORD0			0b01000
#define VERTEXT_TEXTURE_COORD1			0b10000
...
protected:
	...
	int								m_nPoints = 8;
	XMFLOAT3						*m_pxmf3BoundVertex = NULL;
	ID3D12Resource					*m_pd3dBoundBoxBuffer = NULL;
	ID3D12Resource					*m_pd3dBoundBoxUploadBuffer = NULL;
	D3D12_VERTEX_BUFFER_VIEW		m_d3dBoundBoxBufferView;

	int								m_nindices = 24;
	UINT							*m_ppnBbxIndices = NULL;
	ID3D12Resource					*m_ppd3dBbxIndexBuffer = NULL;
	ID3D12Resource					*m_ppd3dBbxIndexUploadBuffer = NULL;
	D3D12_INDEX_BUFFER_VIEW			m_pd3dBbxIndexBufferView;
#endif
...
public:
	...
	void ComputeBoundBox(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList);
	BoundingOrientedBox GetBoundingBox() { return(m_xmBoundingBox); }
#ifdef _WITH_BOUND_BOX
	
	void BbxRender(ID3D12GraphicsCommandList *pd3dCommandList);
	void BbxRender(ID3D12GraphicsCommandList *pd3dCommandList, int nInstance);
