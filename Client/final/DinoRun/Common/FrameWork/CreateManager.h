...
public:
	...
	void SetLoadingScene(shared_ptr<BaseScene> pScene) { m_pLoadingScene = pScene; }
...
private:
	...
	ComPtr<ID3D12Resource> m_ppd3dRenderTargetBuffers[nRendertargetBuffers];
	...
	// RTV / DSV 버퍼 생성용
	D3D12_CPU_DESCRIPTOR_HANDLE m_pRtvRenderTargetBufferCPUHandles[nRendertargetBuffers];
