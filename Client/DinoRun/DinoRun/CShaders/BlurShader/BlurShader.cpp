...
ID3D12Resource* BlurShader::Output()
{
	return mBlurMap0.Get();
}

void BlurShader::BuildDescriptors(D3D12_CPU_DESCRIPTOR_HANDLE hCpuDescriptor,
...
void BlurShader::OnResize(UINT newWidth, UINT newHeight)
{
...
void BlurShader::Dispatch(ID3D12GraphicsCommandList* pCommandList,
...
std::vector<float> BlurShader::CalcGaussWeights(float sigma)
{
...
void BlurShader::BuildDescriptors()
{
...
void BlurShader::BuildResources()
{
...
void BlurShader::ChangeResourceState(ID3D12GraphicsCommandList* pCommandList, ComPtr<ID3D12Resource> pResource, D3D12_RESOURCE_STATES stateBefore, D3D12_RESOURCE_STATES stateAfter)
{
