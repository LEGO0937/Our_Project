...
D3D12_INPUT_LAYOUT_DESC CreateNormalInputLayout()
{
...
void CreatePsoLighting(ID3D12Device *pd3dDevice, ID3D12RootSignature* m_pd3dGraphicsRootSignature, ID3D12PipelineState** m_ppd3dPipelineStates, int idx)
{
	ID3DBlob *pd3dVertexShaderBlob = NULL, *pd3dPixelShaderBlob = NULL;
	D3D12_GRAPHICS_PIPELINE_STATE_DESC d3dPipelineStateDesc;
	::ZeroMemory(&d3dPipelineStateDesc, sizeof(D3D12_GRAPHICS_PIPELINE_STATE_DESC));
	d3dPipelineStateDesc.pRootSignature = m_pd3dGraphicsRootSignature;
	d3dPipelineStateDesc.VS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "VSLighting", "vs_5_1", &pd3dVertexShaderBlob);
	d3dPipelineStateDesc.PS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "PSLighting", "ps_5_1", &pd3dPixelShaderBlob);
	d3dPipelineStateDesc.RasterizerState = CreateRasterizerState();
	d3dPipelineStateDesc.BlendState = CreateBlendState();
	d3dPipelineStateDesc.DepthStencilState = CreateDepthStencilState();
	d3dPipelineStateDesc.InputLayout = CreateNormalInputLayout();
...
void CreatePsoInstancing(ID3D12Device *pd3dDevice, ID3D12RootSignature* m_pd3dGraphicsRootSignature, ID3D12PipelineState** m_ppd3dPipelineStates, int idx)
{
	ID3DBlob *pd3dVertexShaderBlob = NULL, *pd3dPixelShaderBlob = NULL;
	D3D12_GRAPHICS_PIPELINE_STATE_DESC d3dPipelineStateDesc;
	::ZeroMemory(&d3dPipelineStateDesc, sizeof(D3D12_GRAPHICS_PIPELINE_STATE_DESC));
	d3dPipelineStateDesc.pRootSignature = m_pd3dGraphicsRootSignature;
	d3dPipelineStateDesc.VS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "VStextedInstancing", "vs_5_1",
		&pd3dVertexShaderBlob);
	d3dPipelineStateDesc.PS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "PStextedInstancing", "ps_5_1",
		&pd3dPixelShaderBlob);
	d3dPipelineStateDesc.RasterizerState = CreateRasterizerState();
	d3dPipelineStateDesc.BlendState = CreateBlendState();
	d3dPipelineStateDesc.DepthStencilState = CreateDepthStencilState();
...
void CreatePsoTexting(ID3D12Device *pd3dDevice, ID3D12RootSignature* m_pd3dGraphicsRootSignature, ID3D12PipelineState** m_ppd3dPipelineStates, int idx)
{
	ID3DBlob *pd3dVertexShaderBlob = NULL, *pd3dPixelShaderBlob = NULL;
	D3D12_GRAPHICS_PIPELINE_STATE_DESC d3dPipelineStateDesc;
	::ZeroMemory(&d3dPipelineStateDesc, sizeof(D3D12_GRAPHICS_PIPELINE_STATE_DESC));
	d3dPipelineStateDesc.pRootSignature = m_pd3dGraphicsRootSignature;
	d3dPipelineStateDesc.VS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "VSTexting", "vs_5_1",
		&pd3dVertexShaderBlob);
	d3dPipelineStateDesc.PS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "PSTexting", "ps_5_1",
		&pd3dPixelShaderBlob);
	d3dPipelineStateDesc.RasterizerState = CreateRasterizerState();
...
void CreatePsoTerrain(ID3D12Device *pd3dDevice, ID3D12RootSignature* m_pd3dGraphicsRootSignature, ID3D12PipelineState** m_ppd3dPipelineStates, int idx)
{
	...
	::ZeroMemory(&d3dPipelineStateDesc, sizeof(D3D12_GRAPHICS_PIPELINE_STATE_DESC));
	d3dPipelineStateDesc.pRootSignature = m_pd3dGraphicsRootSignature;
	d3dPipelineStateDesc.VS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "VSTer", "vs_5_1",
		&pd3dVertexShaderBlob);
	d3dPipelineStateDesc.PS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "PSTer", "ps_5_1",
		&pd3dPixelShaderBlob);
	d3dPipelineStateDesc.HS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "HS", "hs_5_1",
		&pd3dHullShaderBlob);
	d3dPipelineStateDesc.DS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "DS", "ds_5_1",
...
void CreatePsoUi(ID3D12Device *pd3dDevice, ID3D12RootSignature* m_pd3dGraphicsRootSignature, ID3D12PipelineState** m_ppd3dPipelineStates, int idx)
{
	...
	::ZeroMemory(&d3dPipelineStateDesc, sizeof(D3D12_GRAPHICS_PIPELINE_STATE_DESC));
	d3dPipelineStateDesc.pRootSignature = m_pd3dGraphicsRootSignature;
	d3dPipelineStateDesc.VS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "VSUi", "vs_5_1",
		&pd3dVertexShaderBlob);
	d3dPipelineStateDesc.PS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "PSUi", "ps_5_1",
		&pd3dPixelShaderBlob);
	d3dPipelineStateDesc.RasterizerState = CreateRasterizerState();
	d3dPipelineStateDesc.BlendState = CreateBlendState();
	d3dPipelineStateDesc.DepthStencilState = CreateDepthStencilState();
...
void CreatePsoCube(ID3D12Device *pd3dDevice, ID3D12RootSignature* m_pd3dGraphicsRootSignature, ID3D12PipelineState** m_ppd3dPipelineStates, int idx)
{
	...
	//	&pd3dPixelShaderBlob);
	d3dPipelineStateDesc.VS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "VSSkyBox", "vs_5_1",
		&pd3dVertexShaderBlob);
	d3dPipelineStateDesc.PS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "PSSkyBox", "ps_5_1",
		&pd3dPixelShaderBlob);
	d3dPipelineStateDesc.RasterizerState = CreateRasterizerState();
	d3dPipelineStateDesc.RasterizerState.CullMode = D3D12_CULL_MODE_NONE;
	d3dPipelineStateDesc.BlendState = CreateBlendState();
...
{
	ID3DBlob *pd3dVertexShaderBlob = NULL, *pd3dPixelShaderBlob = NULL, *pd3dGeoShaderBlob;
	D3D12_GRAPHICS_PIPELINE_STATE_DESC d3dPipelineStateDesc;
	::ZeroMemory(&d3dPipelineStateDesc, sizeof(D3D12_GRAPHICS_PIPELINE_STATE_DESC));
	d3dPipelineStateDesc.pRootSignature = m_pd3dGraphicsRootSignature;
	d3dPipelineStateDesc.VS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "VStextedInstancing", "vs_5_1",
	...
	d3dPipelineStateDesc.PS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "PStextedInstancing", "ps_5_1",
		&pd3dPixelShaderBlob);
	d3dPipelineStateDesc.GS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "GS", "gs_5_1",
		&pd3dGeoShaderBlob);
	d3dPipelineStateDesc.RasterizerState = CreateRasterizerState();
	d3dPipelineStateDesc.BlendState = CreateBlendState();
	d3dPipelineStateDesc.DepthStencilState = CreateDepthStencilState();
...
void CreatePsoSurf(ID3D12Device *pd3dDevice, ID3D12RootSignature* m_pd3dGraphicsRootSignature, ID3D12PipelineState** m_ppd3dPipelineStates, int idx)
{
	ID3DBlob *pd3dVertexShaderBlob = NULL, *pd3dPixelShaderBlob = NULL;
	D3D12_GRAPHICS_PIPELINE_STATE_DESC d3dPipelineStateDesc;
	::ZeroMemory(&d3dPipelineStateDesc, sizeof(D3D12_GRAPHICS_PIPELINE_STATE_DESC));
	d3dPipelineStateDesc.pRootSignature = m_pd3dGraphicsRootSignature;
	d3dPipelineStateDesc.VS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "VSSurf", "vs_5_1",
		&pd3dVertexShaderBlob);
	d3dPipelineStateDesc.PS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "PSSurf", "ps_5_1",
		&pd3dPixelShaderBlob);
	d3dPipelineStateDesc.RasterizerState = CreateRasterizerState();
	d3dPipelineStateDesc.RasterizerState.CullMode = D3D12_CULL_MODE_BACK;
	...
	d3dPipelineStateDesc.BlendState.RenderTarget[0].BlendOpAlpha = D3D12_BLEND_OP_ADD;
	...
	d3dPipelineStateDesc.BlendState.RenderTarget[0].LogicOpEnable = false;
	d3dPipelineStateDesc.BlendState.RenderTarget[0].LogicOp = D3D12_LOGIC_OP_NOOP;
	d3dPipelineStateDesc.BlendState.RenderTarget[0].DestBlendAlpha = D3D12_BLEND_ZERO;
...
void CreatePsoGeo(ID3D12Device *pd3dDevice, ID3D12RootSignature* m_pd3dGraphicsRootSignature, ID3D12PipelineState** m_ppd3dPipelineStates, int idx)
{
	ID3DBlob *pd3dVertexShaderBlob = NULL, *pd3dPixelShaderBlob = NULL;
	D3D12_GRAPHICS_PIPELINE_STATE_DESC d3dPipelineStateDesc;
	::ZeroMemory(&d3dPipelineStateDesc, sizeof(D3D12_GRAPHICS_PIPELINE_STATE_DESC));
...
void CreatePsoSkinMesh(ID3D12Device *pd3dDevice, ID3D12RootSignature* m_pd3dGraphicsRootSignature, ID3D12PipelineState** m_ppd3dPipelineStates, int idx)
{
	...
	::ZeroMemory(&d3dPipelineStateDesc, sizeof(D3D12_GRAPHICS_PIPELINE_STATE_DESC));
	d3dPipelineStateDesc.pRootSignature = m_pd3dGraphicsRootSignature;
	d3dPipelineStateDesc.VS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "VSSkinnedAnimationWireFrame", "vs_5_1", &pd3dVertexShaderBlob);
	d3dPipelineStateDesc.PS = CompileShaderFromFile(L"Common/Shaders/Shaders.hlsl", "PSSkinnedAnimationWireFrame", "ps_5_1", &pd3dPixelShaderBlob);
	d3dPipelineStateDesc.RasterizerState = CreateRasterizerState();
